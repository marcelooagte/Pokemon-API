...
{
  if(x<3){
            listtd = document.getElementById('1td')
         }
  if (x >= 3) {
    if (x < 6) {
        listtd = document.getElementById('2td')
    } else if (x < 9) {
      listtd = document.getElementById('3td')
    } else if (x < 12) {
      listtd = document.getElementById('4td')
    } else if (x < 15) {
      listtd = document.getElementById('5td')
    } else if (x < 18) {
      listtd = document.getElementById('6td')
    } else if (x < 21) {
      listtd = document.getElementById('7td')
    }
  }
  return listtd
}
        ...
        fetch(retorno).then(response2 =>
          response2.json().then(dados2 => {
            ;(newItem.src = dados2.sprites.other.dream_world.front_default),
              ...
              for20(x)
              listtd.appendChild(newItem2)
              listtd.appendChild(newItem)
